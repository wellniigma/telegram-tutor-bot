...
def get_main_text():
    return (
        ...
        "📨 Получать уведомления о занятиях, оплате и важной информации от репетитора по обществознанию Алиюшки\n"
        "Прайс:\n"
        "- индивидуальные занятия 90 мин -- 2500 р\n"
        "- занятия в паре 90 мин -- 1900 р\n"
        "- групповые занятия 90 мин -- 1500 р"
    )
